import { c as create_ssr_component, v as validate_component, e as escape, f as compute_rest_props, a as subscribe, g as spread, h as escape_object, b as add_attribute, i as get_store_value } from './ssr-uqARPLdZ.js';
import './appwrite-CTkzZmTY.js';
import { C as Card, a as Card_header, b as Card_title, d as contenu, c as Card_content, A as AddressInput, e as cn } from './AddressInput-ZILfIUTt.js';
import { d as derived, r as readable, w as writable } from './index2-B_uRoZ71.js';
import 'appwrite';
...
const TravelContainer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div>${validate_component(Card, "Card.Root").$$render($$result, { class: "w-1/3" }, {}, {
      default: () => {
        return `${validate_component(Card_header, "Card.Header").$$render($$result, {}, {}, {
          default: () => {
            return `${validate_component(Card_title, "Card.Title").$$render($$result, {}, {}, {
              default: () => {
                return `${escape(contenu[lang].departLocation)}`;
              }
            })}`;
          }
          ...
          default: () => {
            return `${validate_component(AddressInput, "AddressInput").$$render(
              ...
              {}
            )} ${validate_component(Separator, "Separator").$$render($$result, { class: "my-4" }, {}, {})}`;
          }
        })}`;
      }
    })}</div>`;
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `  ${validate_component(TravelContainer, "TravelContainer").$$render($$result, {}, {}, {})}`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-DOi3ug9T.js.map
