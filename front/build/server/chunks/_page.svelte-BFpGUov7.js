import { c as create_ssr_component, v as validate_component, e as escape, f as createEventDispatcher, d as add_attribute, b as each, g as compute_rest_props, h as spread, i as escape_attribute_value, j as escape_object, a as subscribe, k as get_store_value } from './ssr-F6ii-uTE.js';
import { I as Icon, a as Card, b as Card_header, d as Card_title, e as Card_content, c as contenu, A as AddressInput, C as Chevron_down, f as cn } from './AddressInput-keDBUvtI.js';
import './appwrite-CTkzZmTY.js';
import { d as derived, r as readable, w as writable } from './index2-CChkn_po.js';
import 'appwrite';
...
const Vehicule = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="bg-white p-6 rounded-lg shadow-sm max-w-3xl mx-auto"><div class="flex items-center gap-2 mb-8">${validate_component(Car, "Car").$$render($$result, { class: "w-6 h-6 text-amstram-purple" }, {}, {})} <h2 class="text-xl font-medium text-gray-700">${escape(contenu[lang].vehicle)}</h2></div> <div class="grid grid-cols-1 md:grid-cols-2 gap-6"> <div class="space-y-2"><label for="vehicleType" class="block text-lg font-medium text-gray-600">${escape(contenu[lang].vehicleType)}</label> <select id="vehicleType" class="w-full p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black"><option disabled selected value="">${escape(contenu[lang].vehicleType)}</option>${each(vehicleTypes, (type) => {
    ...
    {},
    {}
  )} <input id="makeModel" type="text" placeholder="Enter make and model..." class="w-full pl-10 p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black"${add_attribute("value", makeModel, 0)}></div></div>  <div class="space-y-2"><label for="numberPlate" class="block text-lg font-medium text-gray-600">${escape(contenu[lang].numberPlate)}</label> <div class="relative">${validate_component(File_text, "FileText").$$render(
    $$result,
    {
      class: "absolute left-3 top-3 w-5 h-5 text-gray-400"
    },
    {},
    {}
  )} <input id="numberPlate" type="text" placeholder="AA-123-AA" class="w-full pl-10 p-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-black"${add_attribute("value", numberPlate, 0)}></div></div>  <div class="space-y-2"><label for="seatingCapacity" class="block text-lg font-medium text-gray-600">${escape(contenu[lang].seatingCapacity)}</label> <div class="relative">${validate_component(Users, "Users").$$render(
    $$result,
    {
      class: "absolute left-3 top-3 w-5 h-5 text-gray-400"
    },
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$result.head = previous_head;
    price = 0;
    $$rendered = `<div class="min-h-screen py-4 px-2 sm:px-4"><div class="max-w-fit"> <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4"> <div class="bg-gradient-to-br from-amstram-black/50 to-white/30 rounded-lg shadow-sm p-3 flex items-center justify-center">${validate_component(ServiceRecap, "ServiceRecap").$$render(
      $$result,
      ...
      {}
    )}</div>  <div class="bg-gradient-to-br from-amstram-black/50 to-white/30 rounded-lg shadow-sm p-3 flex items-center justify-center">${validate_component(PhoneVerification, "PhoneVerification").$$render($$result, { lang }, {}, {})}</div></div>  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4"> <div class="bg-white rounded-lg shadow-sm p-3 h-full ">${validate_component(TravelContainer, "TravelContainer").$$render(
      $$result,
      {
        minDate: minDateDepart,
        lang,
      ...
      {}
    )}</div>  <div class="bg-white rounded-lg shadow-sm p-3 h-full ">${validate_component(Vehicule, "Vehicule").$$render($$result, { lang, vehicleType: selectedTypeofVehicle }, {}, {})}</div></div>  <div class="mt-6 flex justify-center"><button class="${"flex items-center justify-center gap-2 " + escape(
      "bg-gray-400",
      true
...
//# sourceMappingURL=_page.svelte-BFpGUov7.js.map
