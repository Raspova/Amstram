...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `<!-- HEAD_svelte-m7tdn8_START --><meta name="title" content="AMSTRAM - Livraison de véhicules sur mesure"><meta name="keywords" content="livraison de véhicules, livraison en europe, livraison en corse, transport de véhicules, livraison sur mesure, transport sur mesure, véhicules de collection, véhicules de luxe, transport de voiture, transport de camion, transport de motocyclette, service de transport de véhicules, livraison de voiture, livraison de camion, livraison de motocyclette"><link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css"><!-- HEAD_svelte-m7tdn8_END -->`, ""} <main class="w-full text-amstram-white font-sans"><div class="section min-h-screen flex flex-col relative transition-colors duration-1000 svelte-s1bvui"><img src="/side.webp" alt="Décoration latérale" class="absolute left-0 top-20 h-full object-cover hidden md:block parallax-bg svelte-s1bvui" style="z-index: -1;"> <header class="flex justify-between items-center p-4 max-w-7xl mx-auto"><div class="absolute left-0 top-0 mt-5 ml-10">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}</div> <div class="absolute right-1 top-3 md:top-9 flex flex-col md:flex-row items-center space-x-4 md:mr-20 mr-1 md:mt-5 mt-5">${validate_component(Login, "Login").$$render($$result, { lang }, {}, {})} <select class="flex mt-5 md:mt-0 items-center space-x-1 border border-amstram-white px-2 py-1 rounded bg-transparent text-amstram-white"><option value="fr" class="text-amstram-black bg-gray-600" data-svelte-h="svelte-1abkoqw">FR</option><option value="en" class="text-amstram-black bg-gray-600" data-svelte-h="svelte-j1c2uy">EN</option></select></div></header> <div class="w-full flex-grow" data-aos="fade-up" data-aos-duration="1500"><section class="max-w-7xl mx-auto mt-24 px-4 sm:px-8"><h2 class="text-5xl font-bold mb-12 text-center md:text-left">${escape(contenu[lang].title)}</h2> <form class="grid grid-cols-1 md:grid-cols-4 gap-6 ml-10 mr-10"><div class="relative">${validate_component(Map_pin, "MapPin").$$render(
    ...
    ""
        ...
        <a href="/confidentiality" class="text-amstram-white hover:underline">${escape(contenu[lang].privacy)}</a></p> <div class="text-gray-300 flex flex-col md:flex-row justify-between items-center"><div class="md:text-left text-center py-2" data-svelte-h="svelte-wan1sm">(CTO) Jonathan Layduhur - <a href="mailto:layduhurdevelopment@gmail.com" class="text-amstram-white hover:underline">layduhurdevelopment@gmail.com</a><br>
          (CEO) Abdoulatif Tall - <a href="mailto:Abd.tall124@gmail.com" class="text-amstram-white hover:underline">Abd.tall124@gmail.com</a><br></div> <div class="py-2">Adresse : 28 Avenue Des Pepinieres, 94260 Fresnes<br> ${escape(contenu[lang].phone)} : <a href="tel:+33766842045" class="text-amstram-white hover:underline" data-svelte-h="svelte-1yssayu">07 66 84 20 45</a></div></div></div></footer></main>  `;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-B_X8Fywl.js.map
