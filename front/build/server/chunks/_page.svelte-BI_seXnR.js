...
const AuthComponant = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${`<div class="flex flex-col items-center justify-center bg-gray-100 text-gray-900 p-4"><div class="w-full max-w-md bg-white rounded-lg shadow-xl overflow-hidden"><div class="flex justify-center p-4 bg-gray-200"><button class="${escape(
...
//# sourceMappingURL=_page.svelte-BI_seXnR.js.map
