import { c as create_ssr_component, v as validate_component, e as escape, j as add_attribute, b as compute_rest_props, d as spread, h as escape_attribute_value, f as escape_object, i as each } from './hooks.server-CKpkIbms.js';
...
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${`<button class="flex items-center space-x-1 bg-amstram-purple px-3 py-1 rounded">${validate_component(Log_in, "LogIn").$$render($$result, { class: "w-4 h-4" }, {}, {})} <span>${escape(contenu[lang].login)}</span></button>`} ${``}`;
});
function cn(...inputs) {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const contenu = {
    ...
    en: {
      ...
      piloteExpress: {
        title: "1. The Express Driver",
        description: "A professional driver takes the wheel of your vehicle for direct delivery. Ideal for fast and personalized delivery.",
        features: ["Door-to-door delivery", "Experienced and certified drivers"]
      },
      coconRoulant: {
        title: "2. The Rolling Cocoon",
        description: "Your vehicle travels comfortably in a specialized truck, preserving its mileage and condition. Perfect for luxury or collectible vehicles.",
  ...
  $$result.css.add(css);
  return `${$$result.head += `<!-- HEAD_svelte-1ynluga_START -->${$$result.title = `<title>AMSTRAM - Livraison de véhicules sur mesure</title>`, ""}<meta name="description" content="AMSTRAM est une entreprise de livraison de véhicules sur mesure dans toute l'Europe. Nous vous proposons des solutions de transport de véhicules adaptées à vos besoins, que vous soyez un particulier ou une entreprise."><meta name="keywords" content="livraison de véhicules, transport de véhicules, livraison sur mesure, transport sur mesure, véhicules de collection, véhicules de luxe, transport de voiture, transport de camion, transport de motocyclette, service de transport de véhicules, livraison de voiture, livraison de camion, livraison de motocyclette"><meta name="author" content="Jonathan Layduhur"><link rel="stylesheet" href="https://unpkg.com/aos@next/dist/aos.css"><!-- HEAD_svelte-1ynluga_END -->`, ""} <main class="w-full text-amstram-white font-sans"><div class="section min-h-screen flex flex-col relative transition-colors duration-1000 svelte-s1bvui"><img src="/side.webp" alt="Décoration latérale" class="absolute left-0 top-20 h-full object-cover hidden md:block parallax-bg svelte-s1bvui" style="z-index: -1;"> <header class="flex justify-between items-center p-4 max-w-7xl mx-auto"><div class="absolute left-0 top-0 mt-5 ml-10">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})}</div> <div class="absolute right-1 top-3 md:top-9 flex flex-col md:flex-row items-center space-x-4 md:mr-20 mr-1 md:mt-5 mt-5">${validate_component(Login, "Login").$$render($$result, { lang }, {}, {})} <select class="flex mt-5 md:mt-0 items-center space-x-1 border border-amstram-white px-2 py-1 rounded bg-transparent text-amstram-white"><option value="fr" class="text-amstram-black bg-gray-600" data-svelte-h="svelte-1abkoqw">FR</option><option value="en" class="text-amstram-black bg-gray-600" data-svelte-h="svelte-j1c2uy">EN</option></select></div></header> <div class="w-full flex-grow" data-aos="fade-up" data-aos-duration="1500"><section class="max-w-7xl mx-auto mt-24 px-4 sm:px-8"><h2 class="text-5xl font-bold mb-12 text-center md:text-left">${escape(contenu[lang].title)}</h2> <form class="grid grid-cols-1 md:grid-cols-4 gap-6 ml-10 mr-10"><div class="relative">${validate_component(Map_pin, "MapPin").$$render(
    $$result,
    {
    ...
    {},
    {}
  )} <input type="text"${add_attribute("placeholder", contenu[lang].departLocation, 0)} class="${"w-full pl-12 pr-4 py-3 rounded-lg bg-white text-amstram-black text-lg " + escape(
    "",
    true
  ) + " " + escape("", true)}"${add_attribute("this", departInput, 0)}> ${``}</div> <div class="relative">${validate_component(Map_pin, "MapPin").$$render(
    $$result,
    {
      class: "absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400"
    },
    {},
    {}
  )} <input type="text"${add_attribute("placeholder", contenu[lang].arrivalLocation, 0)} class="${"w-full pl-12 pr-4 py-3 rounded-lg bg-white text-amstram-black text-lg " + escape(
    "",
    true
  ) + " " + escape("", true)}"${add_attribute("this", arrivalInput, 0)}> ${``}</div> <div class="relative"><select class="${"w-full pl-4 pr-12 py-3 rounded-lg bg-white text-amstram-black appearance-none text-lg " + escape(
    "",
    true
  )}"><option disabled selected value="">${escape(contenu[lang].vehicleType)}</option><option value="citadine">${escape(contenu[lang].citadine)}</option><option value="moto">${escape(contenu[lang].moto)}</option><option value="camion">${escape(contenu[lang].camion)}</option></select> ${validate_component(Chevron_down, "ChevronDown").$$render(
    $$result,
    {
    ...
    {},
    {}
  )}</div> <button ${"disabled"} class="${escape(
    "bg-black bg-opacity-10",
    true
  ) + " text-white py-3 px-6 rounded-lg text-lg font-semibold"}"${add_attribute("this", reserveButton, 0)}>${escape(contenu[lang].reserve)}</button></form></section> <section class="max-w-7xl mx-auto mr-20 mt-24 px-4 sm:px-8 flex flex-col md:flex-row items-center"><div class="md:w-1/2 mb-12 md:mb-0"><p class="text-5xl font-bold mb-6">${escape(contenu[lang].subtitle)}</p> <p class="text-gray-300 text-3xl ">${escape(contenu[lang].description)}</p></div> <div class="hidden lg:block ">${validate_component(Eumap, "Eumap").$$render($$result, {}, {}, {})}</div></section> <img src="/truck.webp" alt="Truck" class="absolute left-0 bottom-0 w-1/8 md:w-1/12 truck-animation hidden md:block svelte-s1bvui" data-aos="fade-left" data-aos-duration="2000" data-aos-delay="1000" data-aos-offset="0"></div></div> <div class="section w-full bg-gray-100 bg-hero-patern-b relative overflow-hidden transition-colors duration-1000 svelte-s1bvui"><img src="/side2.webp" alt="Décoration latérale" class="absolute right-0 bottom-0 object-cover hidden lg:block opacity-50 parallax-bg svelte-s1bvui" style="z-index: 1;"> <div class="min-h-screen flex flex-col justify-center py-12 relative" style="z-index: 2;"><h2 class="text-5xl font-bold mb-5 text-center text-amstram-black" data-aos="fade-up" data-aos-duration="1500">${escape(contenu[lang].offersTitle)}</h2> <section class="max-w-7xl mx-auto mt-12 px-4 sm:px-8 grid grid-cols-1 md:grid-cols-2 gap-12">${validate_component(Card, "Card.Root").$$render(
    $$result,
    {
        ...
        return `${validate_component(Card_header, "Card.Header").$$render($$result, { class: "pt-16" }, {}, {
          default: () => {
            return `${validate_component(Card_title, "Card.Title").$$render(
              ...
              {
                default: () => {
                  return `${escape(contenu[lang].piloteExpress.title)}`;
                }
              }
            )} ${``}`;
          }
          ...
          default: () => {
            return `<img src="driver.webp" alt="Pilote Express" class="w-full h-48 object-cover rounded-lg mb-6"> <p class="text-gray-700 text-lg text-center">${escape(contenu[lang].piloteExpress.description)}</p> <ul class="text-gray-700 mt-4 list-disc pl-5"><li>${escape(contenu[lang].piloteExpress.features[0])}</li> <li>${escape(contenu[lang].piloteExpress.features[1])}</li></ul> ${``}`;
          }
        })}`;
      }
    }
        ...
        return `${validate_component(Card_header, "Card.Header").$$render($$result, { class: "pt-16" }, {}, {
          default: () => {
            return `${validate_component(Card_title, "Card.Title").$$render(
              ...
              {
                default: () => {
                  return `${escape(contenu[lang].coconRoulant.title)}`;
                }
              }
            )} ${``}`;
          }
          ...
          default: () => {
            return `<img src="porte-voitures1.webp" alt="Cocon Roulant" class="w-full h-48 object-cover rounded-lg mb-6"> <p class="text-gray-700 text-lg text-center">${escape(contenu[lang].coconRoulant.description)}</p> <ul class="text-gray-700 mt-4 list-disc pl-5"><li>${escape(contenu[lang].coconRoulant.features[0])}</li> <li>${escape(contenu[lang].coconRoulant.features[1])}</li></ul> ${``}`;
          }
        })}`;
      }
    }
  )}</section></div></div> <div class="section min-h-screen flex flex-col relative overflow-hidden transition-colors duration-1000 svelte-s1bvui"><img src="/side1.webp" alt="Décoration latérale" class="absolute left-1 -bottom-0 h-3/4 w-50 object-cover hidden lg:block " style="z-index: -1;" data-aos="fade-up" data-aos-duration="1500" data-aos-delay="200"> <section class="max-w-7xl mx-auto mt-24 px-4 sm:px-8 flex-grow relative"><img src="/side0.webp" alt="Décoration latérale" class="absolute right-0 bottom-10 w-1/3 w-50 object-cover hidden lg:block parallax-bg svelte-s1bvui" style="z-index: -1;"> <h2 class="text-4xl font-bold mb-12 text-center text-amstram-white" data-aos="fade-up" data-aos-duration="1500">${escape(contenu[lang].why_choose_us)}</h2> <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16"><div class="bg-black bg-opacity-80 outline outline-1 outline-white p-6 rounded-xl" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="100"><div class="flex items-start mb-4"><svg class="w-10 h-10 text-amstram-purple mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5"></path></svg> <h3 class="text-4xl font-semibold text-amstram-white">${escape(contenu[lang].card1Title)}</h3></div> <p class="text-gray-300 text-2xl">${escape(contenu[lang].card1Description)}</p></div> <div class="bg-black bg-opacity-80 outline outline-1 outline-white p-6 rounded-xl" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="200"><div class="flex items-start mb-4"><svg class="w-10 h-10 text-amstram-purple mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg> <h3 class="text-4xl font-semibold text-amstram-white">${escape(contenu[lang].card2Title)}</h3></div> <p class="text-gray-300 text-2xl">${escape(contenu[lang].card2Description)}</p></div> <div class="bg-black bg-opacity-90 outline outline-1 outline-white p-6 rounded-xl" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="300"><div class="flex items-start mb-4"><svg class="w-10 h-10 text-amstram-purple mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08 .402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <h3 class="text-4xl font-semibold text-amstram-white">${escape(contenu[lang].card3Title)}</h3></div> <p class="text-gray-300 text-2xl">${escape(contenu[lang].card3Description)}</p></div> <div class="bg-black bg-opacity-80 outline outline-1 outline-white p-6 rounded-xl" data-aos="zoom-in" data-aos-duration="1500" data-aos-delay="400"><div class="flex items-start mb-4"><svg class="w-10 h-10 text-amstram-purple mr-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg> <h3 class="text-4xl font-semibold text-amstram-white">${escape(contenu[lang].card4Title)}</h3></div> <p class="text-gray-300 text-2xl">${escape(contenu[lang].card4Description)}</p></div></div></section></div>  <div class="fixed right-4 top-1/2 transform -translate-y-1/2 z-50"><div class="flex flex-col space-y-2"><div class="${[
    "w-3 h-3 rounded-full bg-amstram-purple scroll-indicator cursor-pointer svelte-s1bvui",
    "active"
    ...
    "w-3 h-3 rounded-full bg-amstram-purple scroll-indicator cursor-pointer svelte-s1bvui",
    ""
  ].join(" ").trim()}"></div></div></div> <footer class="mt-16 bg-gray-800 py-8 w-full"><div class="max-w-7xl mx-auto px-4 text-center"><p class="text-gray-300">${escape(contenu[lang].footer)}</p> <p class="text-gray-300"><a href="/general_condition" class="text-amstram-white hover:underline">${escape(contenu[lang].terms)}</a> | 
        <a href="/confidentiality" class="text-amstram-white hover:underline">${escape(contenu[lang].privacy)}</a></p> <div class="text-gray-300 flex flex-col md:flex-row justify-between items-center" data-svelte-h="svelte-dakwjv"><div class="md:text-left text-center py-2">(CTO) Jonathan Layduhur - <a href="mailto:layduhurdevelopment@gmail.com" class="text-amstram-white hover:underline">layduhurdevelopment@gmail.com</a><br>
          (CEO) Abdoulatif Tall - <a href="mailto:Abd.tall124@gmail.com" class="text-amstram-white hover:underline">Abd.tall124@gmail.com</a><br></div> <div class="py-2">Adresse : 28 Avenue Des Pepinieres, 94260 Fresnes<br>
          Téléphone : <a href="tel:+33766842045" class="text-amstram-white hover:underline">07 66 84 20 45</a></div></div></div></footer></main>  `;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-B2qVjvYS.js.map
