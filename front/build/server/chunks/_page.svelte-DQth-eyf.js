import { c as create_ssr_component, s as subscribe } from './hooks.server-CKpkIbms.js';
import { p as page } from './stores-DnVZ1DkA.js';
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<div class="container svelte-n6hqs5">${`<h1 id="titleEmail" class="svelte-n6hqs5" data-svelte-h="svelte-w2t49b">Vérification de l&#39;email</h1> <div class="loader svelte-n6hqs5"></div>`}</div>`;
});

export { Page as default };
//# sourceMappingURL=_page.svelte-DQth-eyf.js.map
