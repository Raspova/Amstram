	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-C8LHnpJ5.js'))
			},
			{
				id: "/api/routes/[id]",
				pattern: /^\/api\/routes\/([^/]+?)\/?$/,
				...
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-ByIAZMCQ.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BEmcqMPa.js'))
			},
			{
				id: "/checkout",
				pattern: /^\/checkout\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-BuvMdyoP.js'))
			},
			{
				id: "/confidentiality",
