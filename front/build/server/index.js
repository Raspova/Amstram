...
import { a as afterUpdate, d as decode_pathname, b as decode_params, n as normalize_path, c as disable_search, v as validate_layout_server_exports, e as validate_layout_exports, f as validate_page_server_exports, g as validate_page_exports, m as make_trackable, r as resolve } from './chunks/exports-DLZ4FgfD.js';
...
async function get_hooks() {
  ...
  let handleError;
  let init;
  ({ handle, handleFetch, handleError, init } = await import('./chunks/exports-DLZ4FgfD.js').then(function (n) { return n.h; }).then((n) => n.h));
  let reroute;
  let transport;
  return {
    handle,
