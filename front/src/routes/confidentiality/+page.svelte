...
<body>
    ...
    <section>
        ...
        <p>Cette politique de confidentialité explique comment AMSTRAM collecte, utilise et protège vos informations personnelles lorsque vous utilisez notre plateforme de covoiturage.</p>
    </section>
    ...
    <section>
        ...
        <h3>2.2 Informations de connexion via Google</h3>
        <p>Lorsque vous vous connectez via Google, nous accédons à :</p>
        <ul>
            <li>Votre adresse email Google</li>
            <li>Votre nom tel qu'il apparaît sur votre compte Google</li>
        ...
        <ul>
            ...
            <li>Historique des trajets effectués</li>
        </ul>
    ...
    <section>
        ...
        <ul>
            <li>Nom et photo de profil</li>
            <li>Numéro de téléphone (uniquement après confirmation du trajet)</li>
        </ul>
        <h3>4.2 Avec des tiers</h3>
        <p>Nous ne partageons pas vos informations personnelles avec des tiers, sauf :</p>
        <ul>
    ...
    <section>
        ...
        <ul>
            ...
            <li>Pendant la durée légale requise</li>
